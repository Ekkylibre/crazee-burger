...
export default function BasketCard({
  ...
  return (
    <BasketCardStyled
      className={className}
      $isClickable={isClickable} // Préfixé pour Styled Components
      $hasTitle={hasTitle} // Préfixé pour Styled Components
      $isSelected={isSelected} // Préfixé pour Styled Components
      onClick={onClick}
    >
